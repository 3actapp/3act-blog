...
![A graph showing the habit formation curve, starting steep and then leveling off to an asymptote, with the average time of 66 days marked.](https://i.imgur.com/example.png) *Caption: The path to automaticity follows an asymptotic curve. The biggest gains are made early on, and the process slows as the habit becomes more ingrained. The average time to reach the plateau is 66 days.* 
...
1.  **It takes, on average, more than two months to form a habit, not three weeks.**
2.  **There is no magic number.** The time it takes is highly dependent on the person and the behavior itself.
...
[1] Lally, P., van Jaarsveld, C. H. M., Potts, H. W. W., & Wardle, J. (2010). How are habits formed: Modelling habit formation in the real world. *European Journal of Social Psychology*, *40*(6), 998–1009. [https://onlinelibrary.wiley.com/doi/10.1002/ejsp.674](https://onlinelibrary.wiley.com/doi/10.1002/ejsp.674)
